...
var sortAndSpliceColumns = function (tableColumns, firstVisibleColumnIndex) {
    ...
    var otherColumns = tableColumns.filter(function (col) { return col.type !== TABLE_DATA_TYPE && col.type !== TABLE_GROUP_TYPE; });
